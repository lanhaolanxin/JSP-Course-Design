    ...
    <div style="width: 300px;height: 600px;background-color:#D1D1D1 ;float: left">
        <div>
            <div class="personal-image" style="width: 300px;height: 240px;">
                ...
                <a  title="${user.email}" class="avatar"><img id="img-change"  src="${user.imgUrl}" onclick="selectImg();" width="100" height="100" style="border-radius:50%;margin-top: 60px;margin-left: 90px"></a>
            ...
            <div>
                <form>
                    ...
                    <c:if test="${empty user.phone}">
                        手机号：<span id="phone_span" style="color: grey;margin-left: 180px "></span>
                    </c:if>
                </form>
            </div>
        </div>
