...
<div class="active-head">
    <div style="line-height: 44px;margin-left: 5px">
        <span style="color: white;font-family: Arial;font-size: 18px">Dreamland - PureBlog激活成功页面</span>
    </div>
    <div class="content">
        ...
        <div style="margin-left: 340px"> <span style="font-size: 17px;">您登PureBlog的用户名为：<span style="color: green;font-weight: bold">${email}</span></span></div>
    ...
    <div class="foot" style="position: absolute;left: 280px;float: left;margin-top: 40px">
        <div class="foot-nav clearfix">
            ...
            <div class="foot-nav-col">
                ...
                <ul>
                    <li>
                        <a href="http://com.xt.www" onMouseOut="hideImg()"  onmouseover="showImg()">
                            微信
        ...
        <div class="foot-nav clearfix" style="position: absolute;left: 0px;margin-top: 40px;text-align: center">
            <div class="foot-copyrights" style="margin-left: 200px">
                ...
                <p>
                    ...
                    <span>邮箱：kam_lb@163.com</span>
                </p>
                <p style="margin-top: 8px">&copy;com.xt.www PureBlog版权所有</p>
            </div>
        </div>
