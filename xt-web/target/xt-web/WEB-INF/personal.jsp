...
<div class="author-card follow-box">
    <div class="designer-card card-media">
        ...
        <div class="avatar-container-80 center" style="z-index: 0">
            <a href="#" title="${user.email}" class="avatar" target="_blank" >
                <img src="${user.imgUrl}" width="80" height="80">
            </a>
        ...
        <div class="author-info">
            <p class="author-info-title">
                <a href="#" title="${user.email}"
                   class="title-content" target="_blank">${user.email}
                </a>
            </p>
            <div class="position-info">
                <span>杭州&nbsp;|&nbsp;JAVA攻城狮</span>
            </div>
            <div class="btn-area">
...
<%--                <div style="width: 35px;height:bai'l 18px;background-color: #4cae4c;float: left;line-height: 15px;margin-top: 30px;margin-left: 20px">--%>
...
<%--                </div>--%>
            ...
            <div style="float: left;margin-top: 40px; margin-left: 130px;">
                <a href="/user"><i class="icon icon-edit"></i><span style="margin-left: 10px">修改个人资料</span></a>
            </div>
        </div>
    </div>
    ...
    <div class="dreamland-diff">
        ...
        <div class="list-group">
            <a onclick="changeToActive('category_x',null,null)" class="list-group-item active" id="category_x">全部</a>
    ...
    <div class="dreamland-content" style="background-color: white">
        <div class="content-bar">
            ...
            <div id="manage-dreamland" style="background-color: #F0F0F0;width: 120px;text-align: center;height: 40px;line-height: 40px;float: left;margin-left: 20px" onclick="manage_dreamland();">
                ...
                <span id="manage-span" style="color: black">管理</span>
        ...
        <div id="update-dreamland" style="height: 700px;margin-top: 50px;width: 100%;display: none" >
            <ul style="font-size: 12px" id="update-dreamland-ul">
                ...
                <li class="dreamland-fix">
                    ...
                    <a href="${ctx}/rewrite?cid=${cont.id}"><span class="bar-update">修改</span></a>
                    <hr/>
                </li>
                </c:forEach>
        ...
        <div class="hot-dreamland" style="height: 1020px">
            <div style="text-align: center;margin-top: 20px">热推荐
...
<div class="ibx-advice" onmouseover="changeBackColor();" onmouseout="back2color();">
    <a href="${ctx}/write"><span class="glyphicon glyphicon-edit" aria-hidden="true" style="color:#1b1b1b;font-size:30px;" title="写梦"></span></a>
</div>
                    ...
                    if(ucList!=null) {
                        $(ucList).each(function () {
                            var contHtml = " <li class='dreamland-fix'> <a href='${ctx}/watch?cid="+this.id+"'>"+this.title+"</a><a href='${ctx}/deleteContent?cid="+this.id+"'><span class='bar-delete'>删除</span></a>"
                                +"<a href='${ctx}/rewrite?cid="+this.id+"'><span class='bar-update'>修改</span></a><hr/></li>";
                            startHtml = startHtml + contHtml;
                        });
                        var okHtml = startHtml + endHtml;
