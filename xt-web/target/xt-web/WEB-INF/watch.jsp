...
<div class="container">
    ...
    <div style="position: absolute;margin-left: 980px;margin-top: -40px;">
        ...
        <c:if test="${not empty user}">
            <a name="tj_loginp" href="javascript:void(0);"   class="lb" onclick="personal('${user.id}');" style="color: black"><font color="#9370db">${user.email}, 欢迎您！</font></a>
            &nbsp;&nbsp;
...
<%--    </nav>--%>
    ...
    <div id="content" class="row-fluid">
        ...
        <div class="update-dream">
            <a href="${ctx}/rewrite?cid=${cont.id}"><span style="color: #9370db;font-size: 14px">编辑</span> </a>
        </div>
        </c:if>
