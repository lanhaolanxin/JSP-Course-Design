    ...
    <div class="zhuce_kong" id="dre_div">
    	<div class="zc">
            ...
            <h3>欢迎注册</h3>
                ...
                <input id="nickName" name="nick_name" type="text" class="kuang_txt possword" placeholder="昵称" onblur="checkNickName();">
                  <br/>
                ...
                <div>
               		<input id="protocol" type="checkbox" onclick="checkProtocol();"><span>已阅读并同意<a href="#" target="_blank" ><span class="lan">《PureBlog用户协议》</span></a></span>
                    <br/>
...
<script type="text/javascript">
    ...
    $("#to_register").click (function(){
        if(!checkProtocol()){
            $("#protocol_span").text("请勾选\"阅读并接受PureBlog用户协议\"！").css("color","red");
        }else{
            $("#protocol_span").text("");
        }
